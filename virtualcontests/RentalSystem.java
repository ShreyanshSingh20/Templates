...
public class RentalSystem {
    ...
    static class Pair{
    	int shop;
    	int price;
		public Pair(int shop, int price) {
			super();
			this.shop = shop;
			this.price = price;
		}
    ...
    static class Another{
    	...
    	int movie;
    	int price;
		public Another(int shop, int movie, int price) {
			super();
			this.shop = shop;
			this.movie = movie;
			this.price = price;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<PriorityQueue<Pair>> a=new ArrayList<PriorityQueue<Pair>>();
        for(int i=0;i<234;i++) {
        	a.add(new PriorityQueue<>(1,new Comparator<Pair>() {
        	public int compare(Pair i, Pair j) {
	        	if(i.price==j.price) {
	        		return i.shop-j.shop;
        ...
        PriorityQueue<Pair> u=a.get(1);
        Pair currPair=u.poll();
        Pair other=new Pair(5, 7);

        
      
        
        PriorityQueue < Another > rent = new PriorityQueue < Another >(1, 
			      new Comparator< Another >() { // overriding the compare method
			        public int compare(Another i, Another j) {
			        	if(i.price==j.price) {
			        		return i.shop-j.shop;
        ...
        rent.add(new Another(9, 9, 9));
        Another currAnother=rent.poll();
