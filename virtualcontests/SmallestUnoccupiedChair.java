...
public class SmallestUnoccupiedChair {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < n; i++) {
			...
			a.add(new Pair(new Time(mat[i][0], mat[i][1]), i));
		}
		int tf = f.nextInt();
		...
		Collections.sort(a, new Comparator<Pair>() {
			...
			public int compare(Pair o1, Pair o2) {
				if (o1.t.a == o2.t.a) {
					return o1.t.d - o2.t.d;
				}
				return o1.t.a - o2.t.a;
			}
		...
		for (int i = 0; i < a.size(); i++) {
			ans[a.get(i).friend] = i;
		}
		for (int i = 1; i < a.size(); i++) {
			if (a.get(i).t.a >= a.get(i - 1).t.d) {
				ans[a.get(i).friend] = ans[a.get(i - 1).friend];
			}
		}
