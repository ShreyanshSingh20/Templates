...
public class B {
	...
	static void countClosedIsland(int[][] matrix, int n, int m, ArrayList<ArrayList<Integer>> a) {
	...
	static void dfs(int[][] matrix, int x, int y, int n, int m, int r, int c) {
		...
		dfs(matrix, x - 1, y, n, m, r, c);
		dfs(matrix, x + 1, y, n, m, r, c);
		dfs(matrix, x, y - 1, n, m, r, c);
		dfs(matrix, x, y + 1, n, m, r, c);
	}
